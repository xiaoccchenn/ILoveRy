...
>每一part需要用到的工具中，标记***✔️***为有提供的，标记***✖️***的请自行准备，默认下载密码:***RYNB*** ，另因有较大文件，将使用百度网盘分享，请提前准备)
...
**TB-X605M**|✔|[Root](#联想篇2-1) ***/*** [Twrp](#联想篇2-2)|✔|[Go](#Double-OS-for-TB-X605M)|✖|◾|
